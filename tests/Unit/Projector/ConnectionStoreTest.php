...
final class ConnectionStoreTest extends UnitTestCase
{
    ...
    public function it_create(): void
    {
        ...
        $connectionProvider = new ConnectionRepository($this->store);
    ...
    public function it_load_status(): void
    {
        ...
        $this->assertEquals(ProjectionStatus::RUNNING, (new ConnectionRepository($this->store))->loadStatus());
    }
    ...
    public function it_load_state(bool $success): void
    {
        ...
        $this->assertEquals($success, (new ConnectionRepository($this->store))->loadState());
    }
    ...
    public function it_assert_projection_exists(bool $projectionExists): void
    {
        ...
        $this->assertEquals($projectionExists, (new ConnectionRepository($this->store))->exists());
    }
